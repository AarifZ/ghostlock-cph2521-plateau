...
/* 5.10 family — verified from CPH2521 kernel 5.10.236 via kallsyms + disasm
 * (rt_mutex_*, commit_creds, get_task_cred, __set_task_comm, copy_process,
 *  show_state_filter, get_seccomp_filter, wake_up_new_task). */
#define STRUCT_OFFSETS_5_10 \
  ...
  .task_atomic_flags=0x840, .task_real_cred=0x778, .task_cred=0x780, \
